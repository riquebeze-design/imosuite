...
-- ATENÇÃO: isto é APENAS para demonstração. Em produção, use Supabase Auth + roles.

-- =========================
-- 1) Storage: bucket + policies
-- =========================

-- Criar bucket público para media do site (Hero)
insert into storage.buckets (id, name, public)
values ('site-media', 'site-media', true)
on conflict (id) do update set public = true;

-- Policies para o bucket site-media (público)
-- (DROP/CREATE para compatibilidade)
...
-- Demo: permitir inserir/atualizar catálogo e agentes com anon
...
-- Leads: permitir criar, ler e atualizar (demo)
...
-- Activity logs: permitir criar e ler (demo)
